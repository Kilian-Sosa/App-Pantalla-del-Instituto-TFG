    ...
    <body>
        ...
        <%
            if(session.getAttribute("email") == null){
                ...
                switch(action){
                    case "action":  list = manager.getListByOrder("action", order);
                                  break;
                    case "author":  list = manager.getListByOrder("author", order);
                                  break;
                    case "date":  list = manager.getListByOrder("date", order);
                                  break;
                }
        %>
